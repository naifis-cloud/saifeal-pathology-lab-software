<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="add-rate-to-rate-list-collectionlab.aspx.cs" Inherits="add_rate_to_rate_list_collectionlab" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
                <h1>Add Rate to Rate List Collection Lab
                    <small></small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                    <li><a href="#">Tables</a></li>
                    <li class="active">Add Rate to Rate List Collection Lab</li>
                </ol>
            </section>
        <!-- Main content -->
                            ...
                            <div class="box-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <asp:Repeater ID = "rptCollRates" runat = "server" OnItemDataBound="rptCollRates_ItemDataBound">
                                            <ItemTemplate>
                                                <tr>
