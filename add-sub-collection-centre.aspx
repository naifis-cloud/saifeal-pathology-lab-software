<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="add-sub-collection-centre.aspx.cs" Inherits="add_sub_collection_centre" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
                <h1>Add new sub collection centre</h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Home</a></li>
                    <li><a href="#">Masters</a></li>
                    <li class="active">Add sub collection centre</li>
                </ol>
            </section>
        <!-- Main content -->
                            ...
                            <form role="form">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <div class="form-group">
                                                ...
                                                ControlToValidate="txtCode" runat="server" ErrorMessage="Code" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                ...
                                                ControlToValidate="txtName" runat="server" ErrorMessage="Name" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                            </div>
                                        </div>
                                        <div class="col-xs-3">
                                            <label>Affiliate of</label>
                                            ...
                                            <asp:RequiredFieldValidator SetFocusOnError="true" Display="None" ID="reqvalAffiliateOf"
                                                ControlToValidate="ddlCollCenter" runat="server" ErrorMessage="Affiliate of" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Address</label>
                                        ...
                                        ControlToValidate="txtAddress" runat="server" ErrorMessage="Address" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="row">
                                        <asp:UpdatePanel ID = "updStateCity" runat = "server">
                                            <ContentTemplate>
                                                <div class="col-xs-4">
                                                    ...
                                                    ControlToValidate="ddlState" runat="server" ErrorMessage="State" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="col-xs-4">
                                                    <label>City</label>
                                                    ...
                                                    ControlToValidate="ddlCity" runat="server" ErrorMessage="City" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                                </div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                        <div class="col-xs-4">
                                            ...
                                            ControlToValidate="txtPinCode" runat="server" ErrorMessage="Pincode" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            ControlToValidate="txtEmail" runat="server" ErrorMessage="Email Address" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                            ...
                                            ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="vgSubColCenter"></asp:RegularExpressionValidator>
                                        </div>
                                        <div class="col-xs-3">
                                            <label>Mobile</label>
                                            ...
                                            ControlToValidate="txtMobile" runat="server" ErrorMessage="mobile" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-xs-3">
                                            ...
                                            ControlToValidate="txtPhone" runat="server" ErrorMessage="phone" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            ControlToValidate="txtDoctorName" runat="server" ErrorMessage="Doctor's Name" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-xs-3">
                                            ...
                                            ControlToValidate="txtLabUnit" runat="server" ErrorMessage="Lab Unit" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-xs-3">
                                            ...
                                            ControlToValidate="ddlRateType" runat="server" ErrorMessage="Rate type" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                     <div class="row">
                                        <div class="col-xs-6">
                                            ...
                                            ControlToValidate="txtDepAmt" runat="server" ErrorMessage="Deposit Amount" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                        ...
                                        <div class="col-xs-3">
                                           ...
                                           <asp:RequiredFieldValidator SetFocusOnError="true" Display="None" ID="reqvalusername"
                                            ControlToValidate="txtUsername" runat="server" ErrorMessage="Username" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                        </div>
                                        <div class="col-xs-3">
                                            ...
                                            ControlToValidate="txtpassword" runat="server" ErrorMessage="Password" ValidationGroup="vgSubColCenter"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                    <!-- /.box-body -->
                                    <div class="row">
                                ...
                                <div class="box-footer">
                                    <asp:Button ID = "btnSubmit" runat = "server" CssClass = "btn btn-primary" 
                                        Text = "Submit" ValidationGroup="vgSubColCenter" OnClick="btnSubmit_Click"/>
                                    <asp:ValidationSummary ID="valColCenter" runat="server" HeaderText="Please Provide..."
                                    ValidationGroup="vgSubColCenter" ShowMessageBox="true" DisplayMode="List" ShowSummary="false" />
                                </div>
                            </form>
                        </div>
                        <!-- /.box -->
