<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="dispatch-tests.aspx.cs" Inherits="dispatch_tests" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Dispatch Tests</li>
                </ol>
            </section>
        <!-- Main content -->
                                        ...
                                        <asp:Repeater ID = "rptPatients" runat = "server" OnItemCommand="rptPatients_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="<%#ShowHide(Convert.ToInt32(Eval("inTestStatusId")))%>">
                                                        <asp:TextBox ID = "txtHandOver" placeholder="Handover To" CssClass = "form-control" runat = "server" MaxLength = "100"
                                                        Text = '<%#Eval("stHandOverTo")%>'>
                                                        </asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:Button ID = "btnSubmit" runat = "server" CssClass = "btn btn-primary" Text = "Submit" CommandArgument = '<%#Eval("inPatientId")%>' 
                                                        Visible='<%#ShowHideButton(Convert.ToInt32(Eval("inTestStatusId")))%>'
                                                        CommandName = "eHandOver" OnClientClick = "javascript:return confirm('Are you sure you want to dispatch the report?');"/>
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                        </asp:Repeater>
