<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="user-profile.aspx.cs" Inherits="user_profile" %>
                            ...
                            <form role="form">
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3">
                                            ...
                                            <asp:TextBox ID = "txtUsername" runat = "server" MaxLength = "50" placeholder="username" CssClass = "form-control"
                                ...
                                <div class="box-footer">
                                    <asp:Button ID = "btnSubmit" runat = "server" CssClass = "btn btn-primary" 
                                        Text = "Update Profile" ValidationGroup="vgUsers" OnClick="btnSubmit_Click"/>
